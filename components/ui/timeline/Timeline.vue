  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <div
            class="absolute hidden md:flex left-3 size-10 items-center justify-center rounded-full bg-white md:left-3 dark:bg-black"
          >
            <div
      ...
      <div
        ...
        class="absolute hidden md:block left-8 top-0 w-[2px] overflow-hidden bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-0% via-neutral-200 to-transparent to-[99%] [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] md:left-8 dark:via-neutral-700"
      >
        <Motion
          as="div"
          :style="{
