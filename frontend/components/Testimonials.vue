<template>
  <div class="container mt-32 overflow-hidden relative">
    ...
    <div class="flex animate-slide whitespace-nowrap gap-[24px] ml-[-350px]">
      ...
      <div v-for="testimonial in topTestimonials" :key="testimonial.text" class="w-full inline-block whitespace-normal">
        <div
    ...
    <div class="flex animate-slide whitespace-nowrap gap-[24px] ml-[-175px]">
      <div v-for="testimonial in bottomTestimonials" :key="testimonial.text"
