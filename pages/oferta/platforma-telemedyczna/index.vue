            ...
            <div>
              ...
              <ul class="space-y-4">
                <li v-for="i in 3" :key="i" class="flex items-start gap-3">
                  ...
                  <span>{{ t(`offer.telemedicine.feature${i}`) }}</span>
                </li>
              </ul>
            </div>
...
watch(locale, () => {
  useSeoMeta({
    title: t('seo.telemedicine.title'),
    description: t('seo.telemedicine.description'),
