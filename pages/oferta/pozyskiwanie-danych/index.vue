      ...
      <div class="max-w-5xl mx-auto">
        <section class="text-center mb-14">
          <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            {{ t('offer.dataCollection.heroTitle') }}
          </h1>
          <p class="text-lg md:text-xl text-[var(--secondary-text-color)] max-w-3xl mx-auto mb-10">
            {{ t('offer.dataCollection.heroSubtitle') }}
          </p>

          <div class="rounded-2xl overflow-hidden border border-gray-700/30 shadow-2xl bg-black/20">
            <img
              src="/services/data-collection.svg"
              :alt="t('offer.dataCollection.title')"
              class="w-full h-auto"
            >
          </div>
        </section>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            <div>
              ...
              <ul class="space-y-4">
                <li v-for="i in 3" :key="i" class="flex items-start gap-3">
                  ...
                  <span>{{ t(`offer.dataCollection.feature${i}`) }}</span>
                </li>
              </ul>
            </div>
            ...
            <div class="bg-black/20 rounded-2xl p-6 md:p-8 border border-white/10">
              ...
              <p class="text-[var(--secondary-text-color)] mb-8">
                {{ t('offer.dataCollection.subtitle') }}
              </p>
...
watch(locale, () => {
  useSeoMeta({
    title: t('seo.dataCollection.title'),
    description: t('seo.dataCollection.description'),
